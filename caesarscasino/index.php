<?php
$page_id = 20;
$page_title = 'Caesars Casino';
$body_class = 'page-caesars-casino';
$google_UA = 'UA-50925626-20'
?>
  ...
  <section id="main" class="main">
    <div class="wrapper cf">
        ...
        <div class="form-item">
          ...
          <p class="form-question">When was the last time you visited a Caesars Casino?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you talked about your last experience at a Caesars Casino with a friend, family member or online (e.g. Facebook)?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you recently recommended Caesars Casino to a friend or family member?</p>
          <div class="form-answers form-two-options">
            <div class="form-group">
          		<div class="form-radio">
