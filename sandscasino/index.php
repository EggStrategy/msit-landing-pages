<?php
$page_id = 19;
$page_title = 'Sands Casino';
$body_class = 'page-sands-casino';
$google_UA = 'UA-50925626-19'
?>
  ...
  <section id="main" class="main">
    <div class="wrapper cf">
        ...
        <div class="form-item">
          ...
          <p class="form-question">When was the last time you visited a Sands Casino?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you talked about your last experience at a Sands Casino with a friend, family member or online (e.g. Facebook)?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you recently recommended Sands Casino to a friend or family member?</p>
          <div class="form-answers form-two-options">
            <div class="form-group">
          		<div class="form-radio">
