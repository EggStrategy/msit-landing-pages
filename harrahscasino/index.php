<?php
$page_id = 21;
$page_title = 'Harrah&#8217;s Casino';
$body_class = 'page-harrahs-casino';
$google_UA = 'UA-50925626-21'
?>
  ...
  <section id="main" class="main">
    <div class="wrapper cf">
        ...
        <div class="form-item">
          ...
          <p class="form-question">When was the last time you visited a Harrah&#8217;s Casino?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you talked about your last experience at a Harrah&#8217;s Casino with a friend, family member or online (e.g. Facebook)?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you recently recommended Harrah&#8217;s Casino to a friend or family member?</p>
          <div class="form-answers form-two-options">
            <div class="form-group">
          		<div class="form-radio">
