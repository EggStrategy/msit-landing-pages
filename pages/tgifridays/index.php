<?php
$page_id = 2;
$page_title = 'T.G.I. Friday&#39;s';
$body_class = 'page-tgif';
$google_UA = 'UA-50925626-2'
?>
  ...
  <section id="main" class="main">
    <div class="wrapper cf">
        ...
        <div class="form-item">
          ...
          <p class="form-question">When was the last time you visited T.G.I. Friday's?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you talked about your last experience at T.G.I. Friday's with a friend, family member or online (e.g. Facebook)?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you recently recommended T.G.I. Friday's to a friend or family member?</p>
          <div class="form-answers form-two-options">
            <div class="form-group">
          		<div class="form-radio">
