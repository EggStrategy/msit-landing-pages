<?php
$page_id = 15;
$page_title = 'Hyatt Hotel';
$body_class = 'page-hyatt-hotel';
$google_UA = 'UA-50925626-15'
?>
  ...
  <section id="main" class="main">
    <div class="wrapper cf">
        ...
        <div class="form-item">
          ...
          <p class="form-question">When was the last time you visited a Hyatt Hotel?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you talked about your last experience at a Hyatt Hotel with a friend, family member or online (e.g. Facebook)?</p>
        ...
        <div class="form-item">
          ...
          <p class="form-question">Have you recently recommended Hyatt Hotel to a friend or family member?</p>
          <div class="form-answers form-two-options">
            <div class="form-group">
          		<div class="form-radio">
